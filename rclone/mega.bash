#!/bin/bash
SOURCE_DIR="$HOME/Documents"           # Source directory
REMOTE_NAME="mega"                    # Replace with your Rclone remote name for Mega
REMOTE_DIR="Backup/Documents"           # Destination folder on Mega
...
case "$1" in
    ...
    delete-excluded)
        ...
        rclone delete "$REMOTE_NAME:$REMOTE_DIR" --exclude-from "$EXCLUDE_FILE" --log-file="$LOG_FILE" --log-level INFO
        ;;
    *)
